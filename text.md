...
### WEBサーバーの構築
サーバー側でのアプリケーションのロジックからデータベースとの連携、ファイルの読み書き、外部サービスとの連携など、様々なデータ処理を行うことができます。
...
## 総括
HTML、CSS、Javascriptを学ぶことによって、動的なWEBサイトを構築することが可能ですが、正直、この3つを学んだだけではWEBアプリケーションを作ることは難しい。
その他に覚えることはたくさんあります。
